...
React frontend + Express backend + MariaDB database. Serves the department homepage at \texttt{hydra.newpaltz.edu}.
...
\textbf{Database:} 15 tables including Admins, Events, Faculty, Courses, StudentHighlightBlog, TechBlog, etc.
