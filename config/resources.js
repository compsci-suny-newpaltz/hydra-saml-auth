...
module.exports = {
  ...
  nodes: {
    hydra: {
      ...
      maxContainers: 80, // ~243GB allocatable / 3GB per pod (student + dind)
      gpuEnabled: false,
      gpuCount: 0,
    ...
    chimera: {
      ...
      maxContainers: 80, // ~251GB allocatable / 3GB per pod
      gpuEnabled: true,
      gpuCount: 3,
      gpuModel: 'RTX 3090',
    ...
    cerberus: {
      ...
      maxContainers: 20, // 64GB allocatable / 3GB per pod
      gpuEnabled: true,
      gpuCount: 2,
      gpuModel: 'RTX 5090',
