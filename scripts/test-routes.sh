...
check "ILCC app (/ilcc/)"                  "https://localhost/ilcc/"           "200"
check "ILCC health"                        "https://localhost/ilcc/api/health" "200"
check "ILCC setup (public)"                "https://localhost/ilcc/setup"      "200"
check "ILCC manifest (public)"             "https://localhost/ilcc/api/downloads/manifest" "200"
check "ILCC download (SSO → 302)"          "https://localhost/ilcc/api/downloads/cuh63Linux.zip" "302"
check "ILCC autograder (SSO → 302)"        "https://localhost/ilcc/autograder" "302"
echo ""
